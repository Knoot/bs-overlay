...
1. Установка
Скачайте готовый `index.html` из GitHub Release, затем добавьте этот файл в OBS как `Browser Source` или локальный файл-источник, в зависимости от вашего сценария. Для обычных релизов по тегам `v*` дополнительно публикуется открываемая GitHub Pages-версия.
